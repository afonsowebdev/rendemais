...
function Brand({ nameColor = "var(--ink)", size = 38, sub = null, onClick }) {
  return /* @__PURE__ */ React.createElement("div", { className: "brand", style: { padding: 0, cursor: onClick ? "pointer" : "default" }, onClick }, /* @__PURE__ */ React.createElement("img", { className: "brand-mark", src: "assets/img/files/v2-symbol.svg", alt: "", width: size, height: size, style: { width: size, height: size } }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "brand-name", style: { color: nameColor, fontSize: size * 0.45 } }, "Rende", /* @__PURE__ */ React.createElement("span", { className: "brand-plus" }, "+")), sub && /* @__PURE__ */ React.createElement("div", { className: "brand-sub", style: { color: nameColor === "#fff" ? "rgba(255,255,255,.6)" : "var(--ink-3)" } }, sub)));
}
const NAV_GROUPS = [
  {
    label: "Geral",
