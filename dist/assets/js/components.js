...
function ProfileMenu({ account, go, onLogout }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "profile-menu", ref }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "profile-menu-btn", onClick: () => setOpen((v) => !v), "aria-haspopup": "menu", "aria-expanded": open, "aria-label": "Abrir menu do perfil", title: "Perfil" }, /* @__PURE__ */ React.createElement(Avatar, { account, size: 36 }), /* @__PURE__ */ React.createElement("i", { className: "bx bx-chevron-down profile-menu-chev", "aria-hidden": "true" })), open && /* @__PURE__ */ React.createElement("div", { className: "profile-menu-pop", role: "menu", "aria-label": "Conta" }, /* @__PURE__ */ React.createElement("div", { className: "profile-menu-head" }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700, fontSize: 13.5 } }, (account == null ? void 0 : account.nome) || tr("lbl_my_account")), (account == null ? void 0 : account.email) && /* @__PURE__ */ React.createElement("div", { className: "tiny muted", style: { fontWeight: 600, marginTop: 1 } }, account.email)), /* @__PURE__ */ React.createElement("div", { className: "profile-menu-sep" }), /* @__PURE__ */ React.createElement("button", { type: "button", role: "menuitem", onClick: () => {
    setOpen(false);
    go("perfil");
