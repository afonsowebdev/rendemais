...
function EntryModal({ type, item, onClose }) {
  ...
  const seed = () => {
    ...
    if (type === "perfil") {
      const a = fin.account || {};
      return { nome: a.nome || "", idade: a.idade || "", cidade: a.cidade || "", perfil: a.perfil || "Estudante", estado: a.estado || "Solteiro(a)", habitacao: a.habitacao || "Vive com colegas", foto: a.foto || null };
    }
    return {};
  };
