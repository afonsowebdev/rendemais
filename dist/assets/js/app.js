...
function EntryModal({ type, item, onClose }) {
  ...
  const subs = {
    ...
    meta: "Define um novo objetivo de poupan\xE7a.",
    deposit: item == null ? void 0 : item.nome,
    orcamento: "Define um limite mensal de gastos.",
    sync: "Sincroniza\xE7\xE3o verificada",
    reservar: "Guarda uma parte do saldo deste m\xEAs.",
  ...
  if (type === "meta") {
    ...
    aside = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "modal-info-title" }, "Resumo"), /* @__PURE__ */ React.createElement("div", { className: "modal-info-row" }, /* @__PURE__ */ React.createElement("span", null, "Progresso inicial"), /* @__PURE__ */ React.createElement("b", null, alvoN > 0 ? pct + "%" : "\u2014")), /* @__PURE__ */ React.createElement("div", { className: "modal-info-row" }, /* @__PURE__ */ React.createElement("span", null, "Falta poupar"), /* @__PURE__ */ React.createElement("b", null, BM.eur0(Math.max(0, alvoN - atualN)))));
  } else if (type === "orcamento") {
    const v = num(f.valor);
    aside = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "modal-info-title" }, "Resumo"), /* @__PURE__ */ React.createElement("div", { className: "modal-info-row" }, /* @__PURE__ */ React.createElement("span", null, "M\xE9dia di\xE1ria"), /* @__PURE__ */ React.createElement("b", null, v > 0 ? BM.eur0(v / 30) : "\u2014")), /* @__PURE__ */ React.createElement("div", { className: "modal-info-row" }, /* @__PURE__ */ React.createElement("span", null, "M\xE9dia semanal"), /* @__PURE__ */ React.createElement("b", null, v > 0 ? BM.eur0(v / 4.3) : "\u2014")));
  } else if (type === "deposit") {
    const alvoN = +((item == null ? void 0 : item.alvo) || 0), atualN = +((item == null ? void 0 : item.atual) || 0), v = num(f.valor);
    const novoTotal = atualN + v;
    aside = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "modal-info-title" }, "Resumo"), /* @__PURE__ */ React.createElement("div", { className: "modal-info-row" }, /* @__PURE__ */ React.createElement("span", null, "Total ap\xF3s dep\xF3sito"), /* @__PURE__ */ React.createElement("b", null, BM.eur0(novoTotal))), alvoN > 0 && /* @__PURE__ */ React.createElement("div", { className: "modal-info-row" }, /* @__PURE__ */ React.createElement("span", null, "Ainda falta"), /* @__PURE__ */ React.createElement("b", null, BM.eur0(Math.max(0, alvoN - novoTotal)))));
  }
...
function Shell() {
  ...
  const addItens = [
    ...
    { id: "transferencia", label: "Nova transfer\xEAncia", desc: "Mover dinheiro entre contas", icon: "transfer", disabled: true, onClick: () => {
    } },
    { id: "meta", label: "Novo objetivo", desc: "Criar uma nova meta de poupan\xE7a", icon: "target", onClick: () => open("meta") },
