...
function Paywall() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "content" }, /* @__PURE__ */ React.createElement("div", { className: "card card-pad paywall" }, /* @__PURE__ */ React.createElement("div", { className: "prem-crown" }, /* @__PURE__ */ React.createElement(Icon, { name: "spark", size: 26, color: "#fff" })), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 23, fontWeight: 700, letterSpacing: "-.01em", marginTop: 4 } }, "Rende+ Premium"), /* @__PURE__ */ React.createElement("p", { className: "muted", style: { marginTop: 6, fontSize: 14 } }, "Controla o teu dinheiro com superpoderes."), /* @__PURE__ */ React.createElement("div", { className: "prem-feats" }, PREM_FEATS.map((f) => /* @__PURE__ */ React.createElement("div", { className: "prem-feat", key: f.t }, /* @__PURE__ */ React.createElement("span", { className: "pf-ico" }, /* @__PURE__ */ React.createElement(Icon, { name: f.icon, size: 17, color: "var(--accent)" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("b", null, f.t), /* @__PURE__ */ React.createElement("span", null, f.d))))), /* @__PURE__ */ React.createElement("div", { className: "prem-plans" }, /* @__PURE__ */ React.createElement("button", { className: "prem-plan" + (plano === "month" ? " on" : ""), onClick: () => setPlano("month") }, /* @__PURE__ */ React.createElement("div", { className: "pp-n" }, "MENSAL"), /* @__PURE__ */ React.createElement("div", { className: "pp-v" }, "2,99 \u20AC"), /* @__PURE__ */ React.createElement("div", { className: "pp-s" }, "por m\xEAs")), /* @__PURE__ */ React.createElement("button", { className: "prem-plan" + (plano === "year" ? " on" : ""), onClick: () => setPlano("year") }, /* @__PURE__ */ React.createElement("span", { className: "pp-tag" }, "POUPA 2 MESES"), /* @__PURE__ */ React.createElement("div", { className: "pp-n" }, "ANUAL"), /* @__PURE__ */ React.createElement("div", { className: "pp-v" }, "29,99 \u20AC"), /* @__PURE__ */ React.createElement("div", { className: "pp-s" }, "\u2248 2,50 \u20AC/m\xEAs"))), err && /* @__PURE__ */ React.createElement("div", { className: "alert bad", style: { margin: "0 0 12px", padding: "9px 12px" } }, /* @__PURE__ */ React.createElement(Icon, { name: "info", size: 16, color: "var(--neg)" }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12.5, fontWeight: 700 } }, err)), /* @__PURE__ */ React.createElement("style", null, `@keyframes rmaisSpin{to{transform:rotate(360deg)}}`), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", disabled: busy, style: { width: "100%", justifyContent: "center", padding: 15, fontSize: 15.5, border: "none", opacity: busy ? 0.8 : 1, cursor: busy ? "wait" : "pointer" }, onClick: irParaPagamento }, busy && /* @__PURE__ */ React.createElement("span", { style: { width: 15, height: 15, border: "2px solid rgba(255,255,255,.45)", borderTopColor: "#fff", borderRadius: "50%", display: "inline-block", marginRight: 8, animation: "rmaisSpin .6s linear infinite", verticalAlign: "-2px" } }), busy ? "A abrir pagamento\u2026" : "Assinar " + (plano === "year" ? "plano anual" : "plano mensal")), /* @__PURE__ */ React.createElement("p", { className: "tiny muted", style: { textAlign: "center", marginTop: 10, fontWeight: 600 } }, "Pagamento seguro via Stripe \xB7 cancela quando quiseres \xB7 ", precos[plano].sub)));
}
...
function LembreteModal({ item, onClose, onSave }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, /* @__PURE__ */ React.createElement(Field, { label: "Nome" }, /* @__PURE__ */ React.createElement("input", { className: "input", autoFocus: true, value: f.titulo, onChange: set("titulo"), placeholder: "Ex: Renda, Netflix\u2026" })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement(Field, { label: "Valor" }, /* @__PURE__ */ React.createElement("input", { className: "input", inputMode: "decimal", value: f.valor, onChange: set("valor"), placeholder: "0,00" })), /* @__PURE__ */ React.createElement(Field, { label: "Categoria" }, /* @__PURE__ */ React.createElement("select", { className: "select", value: f.cat, onChange: set("cat") }, catKeys.map((k) => /* @__PURE__ */ React.createElement("option", { key: k, value: k }, BM.cats[k].nome))))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement(Field, { label: "Data de vencimento" }, /* @__PURE__ */ React.createElement("input", { className: "input", type: "date", value: f.data, onChange: set("data") })), /* @__PURE__ */ React.createElement(Field, { label: "Avisar antes" }, /* @__PURE__ */ React.createElement("select", { className: "select", value: f.aviso, onChange: set("aviso") }, [1, 2, 3, 5, 7].map((d) => /* @__PURE__ */ React.createElement("option", { key: d, value: d }, d, " dia", d > 1 ? "s" : "", " antes"))))), /* @__PURE__ */ React.createElement("label", { className: "prem-check" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: f.repete, onChange: (e) => setF((s) => ({ ...s, repete: e.target.checked })) }), " ", /* @__PURE__ */ React.createElement("span", null, "Repetir todos os meses ", /* @__PURE__ */ React.createElement("span", { className: "muted" }, "(ao pagar, reagenda para o m\xEAs seguinte)"))), err && /* @__PURE__ */ React.createElement("div", { className: "alert bad", style: { padding: "9px 12px" } }, /* @__PURE__ */ React.createElement(Icon, { name: "info", size: 16, color: "var(--neg)" }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12.5, fontWeight: 700 } }, err)))
  );
}
function Lembretes() {
...
function GrupoModal({ grupo, onClose, onSave }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, /* @__PURE__ */ React.createElement(Field, { label: "Nome do grupo" }, /* @__PURE__ */ React.createElement("input", { className: "input", autoFocus: true, value: nome, onChange: (e) => setNome(e.target.value), placeholder: "Ex: Casa do Porto, Viagem\u2026" })), /* @__PURE__ */ React.createElement(Field, { label: "Descri\xE7\xE3o", hint: "opcional" }, /* @__PURE__ */ React.createElement("input", { className: "input", value: descricao, onChange: (e) => setDescricao(e.target.value), placeholder: "Ex: Renda e contas da casa" })), !editing && /* @__PURE__ */ React.createElement(Field, { label: "Convidar por email", hint: "Adiciona um de cada vez. Tu (Eu) j\xE1 est\xE1s inclu\xEDdo." }, /* @__PURE__ */ React.createElement("div", { className: "row", style: { gap: 8 } }, /* @__PURE__ */ React.createElement("input", { className: "input", type: "email", value: email, onChange: (e) => setEmail(e.target.value), onKeyDown: (e) => {
      if (e.key === "Enter") {
        e.preventDefault();
        addConvidado();
      }
    }, placeholder: "email@exemplo.com" }), /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn btn-soft", style: { flex: "none" }, onClick: addConvidado }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 14 }), " Adicionar"))), !editing && convidados.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "row", style: { gap: 8, flexWrap: "wrap" } }, convidados.map((c) => /* @__PURE__ */ React.createElement("span", { key: c.email, className: "chip", style: { gap: 7 } }, c.nome, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => setConvidados((a) => a.filter((x) => x.email !== c.email)), style: { background: "none", border: "none", cursor: "pointer", padding: 0, display: "grid", color: "var(--ink-3)" } }, /* @__PURE__ */ React.createElement("span", { style: { transform: "rotate(45deg)", display: "grid" } }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 13, color: "var(--ink-3)" })))))), err && /* @__PURE__ */ React.createElement("div", { className: "alert bad", style: { padding: "9px 12px" } }, /* @__PURE__ */ React.createElement(Icon, { name: "info", size: 16, color: "var(--neg)" }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12.5, fontWeight: 700 } }, err)))
  );
}
...
function AnexoViewer({ anexo, onClose }) {
  return /* @__PURE__ */ React.createElement(
    Modal,
    {
      ...
      onClose,
      footer: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("a", { className: "btn btn-soft", href: anexo.dados, download: anexo.nome || "anexo" }, "Transferir"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: onClose }, "Fechar"))
    },
    /^image\//.test(anexo.tipo) ? /* @__PURE__ */ React.createElement("img", { src: anexo.dados, alt: anexo.nome, style: { width: "100%", borderRadius: 10, display: "block" } }) : /* @__PURE__ */ React.createElement("iframe", { title: anexo.nome, src: anexo.dados, style: { width: "100%", height: "60vh", border: "1px solid var(--border)", borderRadius: 10 } })
  );
}
...
function SubModal({ mesAtual, sub, onClose, onSave }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement(Field, { label: "Tipo" }, /* @__PURE__ */ React.createElement("select", { className: "select", value: f.tipo, onChange: mudarTipo }, /* @__PURE__ */ React.createElement("option", { value: "subscricao" }, "Subscri\xE7\xE3o (servi\xE7o)"), /* @__PURE__ */ React.createElement("option", { value: "despesa" }, "Despesa peri\xF3dica"))), /* @__PURE__ */ React.createElement(Field, { label: "Nome" }, /* @__PURE__ */ React.createElement("input", { className: "input", value: f.nome, onChange: upd("nome"), placeholder: f.tipo === "despesa" ? "Ex: Renda" : "Ex: Netflix" }))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement(Field, { label: "Valor", hint: f.tipo === "despesa" ? "Podes ajustar em cada m\xEAs." : "Ajusta ao teu plano." }, /* @__PURE__ */ React.createElement("input", { className: "input", inputMode: "decimal", value: f.valor, onChange: upd("valor"), placeholder: "0,00" })), /* @__PURE__ */ React.createElement(Field, { label: "Ciclo de cobran\xE7a" }, /* @__PURE__ */ React.createElement("select", { className: "select", value: f.ciclo, onChange: upd("ciclo") }, /* @__PURE__ */ React.createElement("option", { value: "mensal" }, "Mensal"), /* @__PURE__ */ React.createElement("option", { value: "anual" }, "Anual"), /* @__PURE__ */ React.createElement("option", { value: "semanal" }, "Semanal")))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement(Field, { label: "Categoria" }, /* @__PURE__ */ React.createElement("select", { className: "select", value: f.categoria, onChange: upd("categoria") }, catOpts.map((o) => /* @__PURE__ */ React.createElement("option", { key: o.k, value: o.k }, o.nome)))), /* @__PURE__ */ React.createElement(Field, { label: f.tipo === "despesa" ? "Dia de pagamento" : "Dia de renova\xE7\xE3o" }, /* @__PURE__ */ React.createElement("input", { className: "input", type: "number", min: "1", max: "28", value: f.dia, onChange: upd("dia") }))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement(Field, { label: "M\xE9todo de pagamento", hint: "opcional" }, /* @__PURE__ */ React.createElement("input", { className: "input", value: f.metodo, onChange: upd("metodo"), placeholder: "Ex: Visa \u2022\u2022 42" })), /* @__PURE__ */ React.createElement(Field, { label: "Estado" }, /* @__PURE__ */ React.createElement("select", { className: "select", value: f.estado, onChange: upd("estado") }, /* @__PURE__ */ React.createElement("option", { value: "ativa" }, "Ativa"), f.tipo !== "despesa" && /* @__PURE__ */ React.createElement("option", { value: "trial" }, "Trial (per\xEDodo gratuito)"), /* @__PURE__ */ React.createElement("option", { value: "pausada" }, "Pausada"), /* @__PURE__ */ React.createElement("option", { value: "cancelada" }, "Cancelada")))), err && /* @__PURE__ */ React.createElement("div", { className: "alert bad", style: { padding: "9px 12px" } }, /* @__PURE__ */ React.createElement(Icon, { name: "info", size: 16, color: "var(--neg)" }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12.5, fontWeight: 700 } }, err)))
  );
}
