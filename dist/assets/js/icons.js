const BX = {
  ...
  heart: "bx-heart",
  spark: "bx-star",
  dots: "bx-dots-horizontal-rounded",
  logout: "bx-log-out",
  check: "bx-check",
  edit: "bx-pencil",
  trash: "bx-trash",
...
function Icon({ name, size = 18, color = "currentColor", sw = 1.7, style }) {
  ...
  if (name === "google") {
    return /* @__PURE__ */ React.createElement("svg", { width: size, height: size, viewBox: "0 0 48 48", style: { flex: "none" } }, /* @__PURE__ */ React.createElement("path", { fill: "#4285F4", d: "M45 24c0-1.6-.1-2.7-.4-3.9H24v7.5h11.8c-.2 1.9-1.5 4.8-4.4 6.7l-.04.3 6.4 5 .4.04C42.6 36.5 45 30.8 45 24z" }), /* @__PURE__ */ React.createElement("path", { fill: "#34A853", d: "M24 46c5.8 0 10.7-1.9 14.2-5.2l-6.8-5.2c-1.8 1.3-4.3 2.2-7.4 2.2-5.7 0-10.5-3.8-12.2-9l-.3.02-6.6 5.1-.1.3C8.3 41 15.6 46 24 46z" }), /* @__PURE__ */ React.createElement("path", { fill: "#FBBC05", d: "M11.8 28.8c-.5-1.3-.7-2.7-.7-4.2s.3-2.9.7-4.2l-.02-.3-6.7-5.2-.2.1C3.3 18.1 2.5 21 2.5 24s.8 5.9 2.2 8.4l7.1-3.6z" }), /* @__PURE__ */ React.createElement("path", { fill: "#EA4335", d: "M24 9.5c4 0 6.8 1.7 8.3 3.2l6.1-5.9C34.7 3.4 29.8 1.5 24 1.5 15.6 1.5 8.3 6.5 5.7 13.7l7.1 5.5c1.7-5.2 6.5-9.7 11.2-9.7z" }));
  }
  if (BX[name]) {
    return /* @__PURE__ */ React.createElement("i", { className: "bx " + BX[name], style: { fontSize: size, color, lineHeight: 1, display: "inline-flex", flex: "none", ...style }, "aria-hidden": "true" });
  }
  if (name && !P[name] && /[^\x00-\x7F]/.test(name)) {
    return /* @__PURE__ */ React.createElement("span", { style: { fontSize: Math.round(size * 0.96), lineHeight: 1, width: size, height: size, display: "inline-grid", placeItems: "center", flex: "none" } }, name);
  }
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: P[name] || P.dots })
  );
}
window.Icon = Icon;
