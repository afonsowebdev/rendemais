...
function Dashboard({ go, open }) {
  ...
  if (!hasData) {
    ...
    ].map(([ic, ti, d]) => /* @__PURE__ */ React.createElement("div", { className: "card card-pad", key: ti }, /* @__PURE__ */ React.createElement("div", { className: "kpi-ico", style: { background: "var(--accent-soft)", marginBottom: 12 } }, /* @__PURE__ */ React.createElement(Icon, { name: ic, size: 19, color: "var(--accent)" })), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700, fontSize: 15 } }, ti), /* @__PURE__ */ React.createElement("div", { className: "tiny muted", style: { marginTop: 5, fontWeight: 600, lineHeight: 1.5 } }, d)))));
  }
  const alerts = [];
