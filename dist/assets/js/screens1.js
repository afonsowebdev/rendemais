...
function Transacoes({ open }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "content", style: { paddingBottom: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "pg-tabs", style: { width: "fit-content" } }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "pg-tab" + (tab === "despesas" ? " on" : ""), onClick: () => setTab("despesas") }, /* @__PURE__ */ React.createElement(Icon, { name: "wallet", size: 15 }), " Despesas"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "pg-tab" + (tab === "rendimentos" ? " on" : ""), onClick: () => setTab("rendimentos") }, /* @__PURE__ */ React.createElement(Icon, { name: "arrowsDown", size: 15 }), " Receitas"))), tab === "despesas" ? /* @__PURE__ */ React.createElement(Despesas, { open }) : /* @__PURE__ */ React.createElement(Rendimentos, { open }));
}
